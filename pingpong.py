...
clock = time.Clock()
FPS = 60
player1 = input('Введи никнейм 1 игрока:')
player2 = input('Введи никнейм 2 игрока:')
...
ball1 = Ball('ball.png',320,200,50,50,5)
...
while game:
    if finish != True:
        ...
        text_count1 = font1.render(player1+':' +str(count1),1,(255,255,255))
        text_count2 = font1.render(player2+':' +str(count2),1,(255,255,255))
        text_win1 = font1.render('ПОБЕДИЛ КРАСНЫЙ,НАЖМИ R ДЛЯ РЕСТАРТА',1,(45,199,0))
        text_win2 = font1.render('ПОБЕДИЛ СИНИЙ,НАЖМИ R ДЛЯ РЕСТАРТА',1,(45,199,0))
        if ball1.rect.x > 650:
            ball1.rect.x = 320
            ball1.rect.y = 200
            count1 += 1
        ...
        window.blit(text_count2,(500,10))
